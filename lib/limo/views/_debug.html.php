...
if (option('env') > ENV_PRODUCTION && option('debug')): ?>
    ...
    if (!$is_http_error): ?>
        <p>[<?php
            ...
            <?php
            echo $errstr ?> (in <strong><?php
                echo $errfile ?></strong> line <strong><?php
                echo $errline ?></strong>)
        </p>
    <?php
    endif; ?>
    ...
    if ($debug_args = set('_lim_err_debug_args')): ?>
        ...
        <pre><code><?php
                echo h(print_r($debug_args, true)) ?></code></pre>
    <?php
    endif; ?>

    <h2 id="limo-options">Options</strong></h2>
    <pre><code><?php
            echo h(print_r(option(), true)) ?></code></pre>
    <p class="bt top"><a href="#header">[ &#x2191; ]</a></p>

    <h2 id="environment">Environment</h2>
    <pre><code><?php
            echo h(print_r(env(), true)) ?></code></pre>
    <p class="bt top"><a href="#header">[ &#x2191; ]</a></p>

    <h2 id="debug-backtrace">Backtrace</h2>
    <pre><code><?php
            echo h(print_r(debug_backtrace(), true)) ?></code></pre>
    <p class="bt top"><a href="#header">[ &#x2191; ]</a></p>
