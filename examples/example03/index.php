...
function before($route = [])
{
    ...
    if (@$route['options']['validation_function']) {
        call_user_func_array($route['options']['validation_function'], params()) or halt("Woops! Params did not pass validation");
    }
}
...
dispatch(
    '/validate/*',
    'validate_test',
    ['validation_function' => 'a_silly_validation_function']
);
...
function a_silly_validation_function($params)
{
    ...
    return isset($params[0]) && $params[0] == "1234";
}
