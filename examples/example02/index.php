...
function welcome()
{
    ...
    switch ($name) {
        ...
        case "bob":
            halt(HTTP_UNAUTHORIZED, "no, go away!", [1, 2, 3]);
            break;
        ...
        default:
            trigger_error("Not sure $name lives in Twin Peaks");
...
function html_my_layout($vars)
{
    ...
    <body>
    <h1>Limo second example: errors</h1>
    <?php
    echo $content ?>
    <hr>
    <p>
        ...
        echo url_for('/') ?>">Home</a> |
        <a href="<?php
        echo url_for('/everything/is_going_wrong') ?>">everything is going wrong</a> |
        <a href="<?php
        echo url_for('/welcome/') ?>">Welcome !</a> |
        <a href="<?php
        echo url_for('/welcome/bill') ?>">Welcome Bill ?</a> |
        <a href="<?php
        echo url_for('/welcome/leland') ?>">Welcome Leland ?</a> |
        <a href="<?php
        echo url_for('/welcome/bob') ?>">Welcome Bob ?</a> |
        <a href="<?php
        echo url_for('/welcome/david') ?>">Welcome David ?</a> |
        <a href="<?php
        echo url_for('/welcome/audrey') ?>">Welcome Audrey ?</a> |
    </p>
    </body>
    </html>
    <!--
